    ...
    render() {
        ...
        return (
            <div className="grid grid-cols-2 gap-1">
                <div className="xs:col-span-2 row-span-2 h-96 xs:h-80">
                    <Image className="lazyload object-cover object-center w-full h-96" layout="fill" src={`${imageBaseUrl}/${images[0]}`} />
                </div>
